  ...
  if (variant === "ticked") {
    return (
      ...
      >
        ...
        <line x1="25%" y1="9" x2="25%" y2="15" stroke="var(--graphite-600)" strokeWidth="1" strokeOpacity="0.6" />
        <line x1="75%" y1="9" x2="75%" y2="15" stroke="var(--graphite-600)" strokeWidth="1" strokeOpacity="0.6" />
